    ...
    static class ConditionalCompilationUtility
    {
        ...
        public static bool enabled
        {
            get
            {
                ...
                return PlayerSettings.GetScriptingDefineSymbols( NamedBuildTarget.FromBuildTargetGroup(buildTargetGroup)).Contains(k_EnableCCU);
            }
        }
        ...
        static void UpdateDependencies(bool reset = false)
        {
            ...
            var previousProjectDefines = PlayerSettings.GetScriptingDefineSymbols(NamedBuildTarget.FromBuildTargetGroup(buildTargetGroup));
            ...
            if (!projectDefines.Contains(k_EnableCCU, StringComparer.OrdinalIgnoreCase))
            {
                ...
                PlayerSettings.SetScriptingDefineSymbols(NamedBuildTarget.FromBuildTargetGroup(buildTargetGroup), string.Join(";", projectDefines.ToArray()));
