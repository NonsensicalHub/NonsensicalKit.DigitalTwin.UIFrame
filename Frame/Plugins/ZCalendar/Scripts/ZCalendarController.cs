...
namespace ZTools
{
    public class ZCalendarController
    {
        ...
        public System.Globalization.ChineseLunisolarCalendar
            cncld = new System.Globalization.ChineseLunisolarCalendar();
        ...
        void FillNextMonth()
        {
            ...
            if (nextMonthDays != 0)
            {
                ...
                {
                    for (int i = 42 - nextMonthDays; i < 42; i++)
                    {
                        zCalendarModel.RecycleItem(i);
                    }
                }
            }
        }
        ...
        void AddDayItem(DateTime dateTime)
        {
            ...
            //zCalendar.onDayRefresh.Invoke(crtDayItem.dateTime);
