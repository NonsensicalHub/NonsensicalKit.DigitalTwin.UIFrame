...
namespace ZTools
{
    public class ZCalendarModel : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            selectTiemObj.alpha = rangeCalendar ? 1 : 0;
        }
        /// <summary>
        /// 生成一个日期对象
        /// </summary>
        ...
        public ZCalendarDayItem Instantiate()
        {
            ...
            else
            {
                ...
                if (zCalendarController.crtDayIndex >= dayItemList.Count)
                {
                    crtItem = Instantiate(dayItem, dayContent);
                    dayItemList.Add(crtItem);
                }
        ...
        {
            if (index < dayItemList.Count)
            {
                dayItemList[index].CloseClickAble();
            }
        }
        /// <summary>
        /// 根据日历尺寸，设置宽高
